...
const { loginDriver, getRoutes, startTrip, endTrip, registerDriver, getAllDrivers, tripDetails } = require('../controlles/driverController');
const router = express.Router();

router.post('/login', loginDriver);
router.post('/register', registerDriver);//tested
router.get('/list', getAllDrivers); //tested

router.patch('/update/driver/:driverid', async (req, res) => {
  ...
  try {
    ...
    res.status(500).json({
      message: "An error occurred while updating driver information",
